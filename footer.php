  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
              Satna<br>
              Madhay Pradesh, India <br><br>
              <strong>Phone:</strong> +91-7339896427<br>
              <strong>Email:</strong> tiwariomkar1989@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        ...
        <a href="https://www.facebook.com/omkar.tiwari.79677471" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/omkartiwari93/" class="instagram"><i class="bx bxl-instagram"></i></a>
        <a href="skype:live:.cid.1b5c6f5cd13b3351?chat" class="google-plus"><i class="bx bxl-skype"></i></a>
